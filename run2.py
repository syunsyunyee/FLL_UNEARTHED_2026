...
def go_to_whats_on_sale():
        ...
        move(123)         #세일 상품 미션을 해결하기위해 앞으로 이동하여 
        curve(700, 500, -45, 0)     #왼쪽으로 45도 회전하여 방향 맞추기
        move(330)         #세일 상품을 올리기 위해 앞으로 이동
def whats_on_sale():
        curve(700, 500, -50, 0)     #왼쪽으로 50도 돌며 레버를 내리고 상품을 들어올리기
        curve(300, 300, 50, 70)     #오른쪽으로 돌며 저울 기울이기 및 지붕을 올리기 위한 방향 맞추기
        b_motor_run(700, -120)      #왼쪽 모터를 돌리며 저울 기울이기 해결 및 지붕 잡기
...
def tip_the_scale():
        ...
        curve(100, 100, -70, 0)     #옆으로 회전하며 완전히 뽑기
def go_home():
        wait(1000)
        curve(700, 700, -14, 4500)
