...
def go_and_solve_map_reveal():
        ...
        move(651)         #지도 공개 미션을 하기 위해 앞으로 이동
        curve(100, 100, -45, 45)    #42도 회젼하며 방향 맞추기
        move(250, 300, 300)         #앞으로 이동하여 미션 해결
...
def go_and_solve_surface_brushing():
        ...
        wait(500)
        b_motor_run(700, -705)       #렉기어 올리며 미션 해결
        drive_base.stop()
        wait(250)
def go_home():
        move(-130, 200, 200)        #뒤로 150(mm)이동하여 홈으로 들어가기 위해 위치 맞추기
        curve(700, 700, 100, 0)     #100도 회전하여 홈이랑 방향 맞추기
        drive_base.use_gyro(False)
        move(-600)        #뒤로 이동하여 홈으로 돌아오기
